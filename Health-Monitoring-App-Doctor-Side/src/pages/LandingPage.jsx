...
import { Calendar, MessageCircle, Activity, Heart, Shield, Users } from 'lucide-react';
...
// Updated useEffect for the typing animation
useEffect(() => {
  let index = 0;
  const fullMessage = "Welcome to Doctor's Hub";
  
  // Type out the message character by character
  const typingInterval = setInterval(() => {
    if (index < fullMessage.length) {
      setDisplayText(fullMessage.substring(0, index + 1));
      index++;
    } else {
      // Once finished typing, clear the interval
    ...
    <div className={`min-h-screen ${darkMode ? "bg-gray-950 text-white" : "bg-white text-gray-900"}`}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          >
            <h1 className={`text-5xl md:text-6xl font-bold mb-6 ${darkMode ? "text-white" : "text-gray-900"}`}>
              {displayText}
              {displayText !== "Welcome to Doctor's Hub" && (
      ...
      <div className={`py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden ${darkMode ? "bg-gradient-to-br from-blue-900 to-gray-900" : "bg-gradient-to-br from-blue-500 to-blue-700"}`}>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Start using Doctor's Hub today and experience a more efficient way to manage your healthcare services.
          </motion.p>
          <motion.div
